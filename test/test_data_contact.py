...
def test_info_on_home_page(app):
    ...
    contact_home_page = app.contact.get_contact_list()[3]
    ...
    # assert contact_home_page.mphone == sub("[() -]", "", contact_edit_page.mphone)
    # assert contact_home_page.wphone == sub("[() -]", "", contact_edit_page.wphone)
    # assert contact_home_page.hphone2 == sub("[() -]", "", contact_edit_page.hphone2)
